...
#define PIN        4 // DataPIN on Arduino Uno 7
...
void loop() 
{
  ...
  hr1 = now.hour();
  ss1 = now.second();
  int hrsdisplay = hr * 1000000 + mm* 10000 +  ss;
  ...
  btn.tick();
    ...
    led_module.drawMarquee("Hi VIPUL, Vismay and Miten....",30, (32 * ROW), 0);
    //led_module.drawMarquee(hrsdisplay,25, (32 * ROW), 0);
